...
const AppbarLang = () => {
  ...
  return (
    <div className="relative w-30 h-10">
      ...
      <div
        className={`drop-list absolute top-full w-full bg-gray-950 ${
              ...
              if (Object.keys(country?.languages)) {
                ...
                return (
                  <div
                    ...
                    className="drop-item flex item-center gap-3 py-1 px-0 hover:bg-gray-700 transition-all duration-200 cursor-pointer"
                    onClick={() =>
