  ...
  return (
    <div className="block-wrap w-full lg:w-auto sm:mt-[14px] lg:mt-0">
      ...
      <div className="table-products">
        <table className="md:min-w-p[500px] w-full">
          <thead>
            <tr>
          ...
          <tbody>
            {/* Cannot read properties of null (reading 'map') 해결 방법 : state 뒤에 ? 추가 */}
            {state?.map((item, idx) => (
              <tr key={idx}>
                ...
                <td className="tbl-data text-center">{item.salespercent}</td>
              </tr>
            ))}
          </tbody>
        </table>
